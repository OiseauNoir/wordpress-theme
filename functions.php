...
function wednesday_setup() {
  ...
  wp_enqueue_style( 'lora', get_template_directory_uri() . 'https://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic');
  wp_enqueue_style( 'open-sans', get_template_directory_uri() . 'https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800');
  ...
  wp_enqueue_script( 'contact_me', get_template_directory_uri() . '/js/contact_me.js', array ( 'jqBootstrapValidation' ), '1.0.0', true);
}
